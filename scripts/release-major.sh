...
# Release major version (e.g., 1.5.3 -> 2.0.0)
...
echo "⚠️  WARNING: This is a MAJOR release (breaking changes expected)"
...
# Create tag
git tag -a "v$NEW_VERSION" -m "Release v$NEW_VERSION - Major release"
